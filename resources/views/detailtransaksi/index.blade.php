...
$('#modalForm').on('submit', function(e){
    ...
    function addForm(url){
        ...
        $('#modalForm [id_transaksi=_method]').val('post');
        $('#modalForm [id_paket=_method]').val('post');
        $('#modalForm [qty=_method]').val('post');
        $('#modalForm [keterangan=_method]').val('post');
    }
    function editData(url){
        ...
        $('#modalForm form')[0].reset();
        $('#modalForm form').attr('action', url);
        $('#modalForm [id_transaksi=_method]').val('put');
        $('#modalForm [qty=_method]').val('put');
        $('#modalForm [keterangan=_method]').val('put');
        $.get (url)
            .done((response) => {
