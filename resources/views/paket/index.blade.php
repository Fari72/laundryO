...
$('#modalForm').on('submit', function(e){
    ...
    function addForm(url){
        ...
        $('#modalForm [jenis=_method]').val('post');
        $('#modalForm [nama_paket=_method]').val('post');
        $('#modalForm [harga=_method]').val('post');
    }
    function editData(url){
        ...
        $('#modalForm [jenis=_method]').val('put');
        $('#modalForm [nama_paket=_method]').val('put');
        $('#modalForm [harga=_method]').val('put');
        $.get (url)
            .done((response) => {
